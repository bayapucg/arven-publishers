...
<div class="ab_class">
   <div class="">
      <div class="">
         <div id="bootstrap-touch-slider" class="carousel bs-slider slide  control-round indicators-line" data-ride="" data-pause="hover" data-interval="5000" >
            <!-- Indicators -->
                  ...
                  <div class="container">
                     <div class="row">
                        ...
                        <div class="slide-text slide_style_center">
                           <h1 data-animation="animated zoomInRight">Journal of Agriculture Research</h1>
                           <p data-animation="animated fadeInLeft">Journal of Agricultural Science and Food Research discusses the latest research innovations and important developments in this field.</p>
               ...
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div class="article-head clearfix">
                     <span class="pull-left">
                        <h4 style="line-height:30px">Research Article</h4>
                     </span>
                     <div class="get-here">
                        <ul>
                           <li>
                     ...
                     <div class="row">
                        <div class="col-lg-10 col-md-9 col-sm-10 col-xs-8">
                           <div class="article-details">
                              ...
                              <h6><a href="#" target="_blank" style="color:#3f51b5;">Journal of Forensic Sciences &amp; Criminal Investigation </a></h6>
         ...
         <div class="sidebar side-bar right-sidebar">
            <div class="widget sidebar-newsletter">
               ...
               <div class="cp-newsletter-holder">
                  <a href="#"> <img class="img-responsive" src="img/submit-menu.jpg" alt="submit Manuscript"></a>
               </div>
            </div>
            <!-- Widget Start -->
            <div class="widget sidebar-newsletter">
