        ...
        <div class="top-bar  bg-dark">
            ...
            <div class="container ">
                <div class=" row border_bootom">
                    ...
                    <div class="col-sm-6 ">
                        <ul class="small_menu ">
                        <li class="hidden-xs"><a ><i class="fa fa-volume-control-phone font-18" aria-hidden="true"></i> &nbsp; 99510*******</a></li>                 
                        <li class="hidden-xs"><a ><i class="fa fa-envelope font-18" aria-hidden="true"></i> &nbsp; contact@arven.com</a></li> 
						<li><a class="btn btn-primary btn-xs" href="menuscript.php">Submit Manuscript</a></li>                 
